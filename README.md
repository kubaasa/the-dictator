...
- One hotkey → transcribed, polished, pasted
- 100% offline option (local Whisper)
...
- Languages: auto-detect, English, Polish, and more
...
- Jeden skrót → transkrypcja, AI polish, wklejone
- 100% offline (lokalny Whisper)
...
- Języki: auto-detect, polski, angielski i więcej
